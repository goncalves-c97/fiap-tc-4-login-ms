...
builder.Services.AddScoped<IDbConnection>(provider =>
{
    ...
    SqlMapper.SetTypeMap(typeof(Cliente), new SnakeCaseTypeMapper<Cliente>());
    SqlMapper.SetTypeMap(typeof(Colaborador), new SnakeCaseTypeMapper<Colaborador>());
    SqlMapper.SetTypeMap(typeof(FuncaoColaborador), new SnakeCaseTypeMapper<FuncaoColaborador>());
